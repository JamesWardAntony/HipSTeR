...
var ParamSets = params.Sets{
	{Name: "Base", Desc: "these are the best params", Sheets: params.Sheets{
		"Network": &params.Sheet{
			//JWA note . (general class) and # (specific) and nothing is a type
			...
			// JWA 3_10_21 change! - 3_16_21 this really killed learning!
			//3_17
			{Sel: "Layer", Desc: "layer decay",
				Params: params.Params{
			...
			{Sel: ".EcCa1Prjn", Desc: "encoder projections -- no norm, moment",
				Params: params.Params{
					...
					//"Prjn.Learn.XCal.SetLLrn": "false", // bcm = better!  now avail //JWA set to true for BCM (no EDL)
					//"Prjn.Learn.XCal.LLrn":    "1",     // combo w/ above
				}},
			...
			{Sel: ".PPath", Desc: "perforant path, new Dg error-driven EcCa1Prjn prjns",
				Params: params.Params{
					...
					//"Prjn.Learn.XCal.SetLLrn": "false", //JWA this gives all BCM (no EDL) if true, if false we have BCM but it's balanced w/ AvgLLearn
					//"Prjn.Learn.XCal.LLrn":    "1",     // JWA this in combo w/ above gives all BCM (no EDL)
			...
			{Sel: "#ECoutToECin", Desc: "one-to-one out to in",
				Params: params.Params{
					...
					"Prjn.WtScale.Rel": "0.4", // .5 = .3? > .8 (fails) //JWA, was 0.5 from Alan - turn this UP if we want more loopiness
					// JWA could also (if we add a cortex) mess with and turn this up, coming from cortex to ECin
					// JWA good candidate of encoding-retrieval differences (like driven by ACh or whatever)
					// JWA - try turning this up/down 0.4>0.3>0.2
				}},
			...
			{Sel: "#DG", Desc: "very sparse = high inibhition",
				Params: params.Params{
					...
					"Layer.Inhib.Layer.Gi":    "2.95", // 3.8 > 3.6 > 4.0 (too far -- tanks) //JWA, was 3.8, did 2.9 (8 tp) until 3/25/22, tried 2.95 w/ 7x7 and 12 tp
	...
	{Name: "List016", Desc: "list size", Sheets: params.Sheets{
		"Pat": &params.Sheet{
			{Sel: "PatParams", Desc: "pattern params",
				Params: params.Params{
					"PatParams.ListSize": "16",
				}},
		},
	}},
	...
	{Name: "MedHip", Desc: "hippo size", Sheets: params.Sheets{
		"Hip": &params.Sheet{
			{Sel: "HipParams", Desc: "hip sizes",
				Params: params.Params{
					"HipParams.ECPool.Y":  "7", //JWA was 7x7, was 10x10 before April 2022
					"HipParams.ECPool.X":  "7",
